 ...
 * @since 2.0
 */
class SolucionReclamoSugerenciaActionColumn extends Column
{
    /**
    ...
    protected function initDefaultButtons()
    {
        ...
        if (!isset($this->buttons['delete'])) {
            $this->buttons['delete'] = function ($url, $model, $key) {
                $options = array_merge([
                    ...
                    'data-confirm' => Yii::t('yii', '¿Está seguro de que desea elminar la Solicitud?'),
                    'data-method' => 'post',
                    'data-pjax' => '0',
                ], $this->buttonOptions);
        ...
        if (!isset($this->buttons['evaluate'])) {
            $this->buttons['evaluate'] = function ($url, $model, $key) {
                $options = array_merge([
                    'title' => Yii::t('yii', 'Evaluar'),
                    'aria-label' => Yii::t('yii', 'Evaluate'),
                    'data-pjax' => '0',
                ], $this->buttonOptions);
        ...
        if (!isset($this->buttons['resultados'])) {
            $this->buttons['resultados'] = function ($url, $model, $key) {
                $options = array_merge([
                    'title' => Yii::t('yii', 'Resultados'),
        ...
        if (!isset($this->buttons['derivate'])) {
            $this->buttons['derivate'] = function ($url, $model, $key) {
                $options = array_merge([
                    'title' => Yii::t('yii', 'Derivar'),
                    'aria-label' => Yii::t('yii', 'resultados'),
                    'data-pjax' => '0',
                ], $this->buttonOptions);
